...
<%
	...
	if(b == null){
		...
		out.println("<form action=\"excluir.jsp\">");
				...
				out.println("<input type=\"text\" name=\"local\" size=\"25\" value=\""+b.getLocal()+"\" readonly=\"true\"/><br>");
				out.println("<a class=\"main-form\">Resultado:</a> <br>");
				out.println("<input type=\"text\" name=\"resultado\" size=\"25\" value=\""+b.getResultado()+"\" readonly=\"true\"/><br>");
			out.println("<p><input type=\"submit\" value=\"Excluir\" class=\"button\"/></p>");
		out.println("</form>");
		out.println("</div>");
	}
%>
